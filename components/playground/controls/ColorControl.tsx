    ...
    <div>
      ...
      <div className="flex items-center gap-2">
        ...
        <input
          ...
          onChange={(e) => onChange(e.target.value)}
          className="flex-1 px-3 py-2 bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg text-zinc-900 dark:text-white text-xs font-mono focus:outline-none focus:border-[#76b900] transition-colors"
        />
      </div>
    </div>
  )
